      ...
      <div className="add-account-form bg-white d-flex flex-column col-lg-10 col-12 rounded-2 p-3 shadow gap-3 mt-2 overflow-hidden">
        <form onSubmit={(e)=>handleSubmit(e, dates)} className="d-flex flex-wrap gap-3">
          ...
          <div className="col-12 col-lg-2">
            ...
            <input onChange={(e)=>handleChange(e)} type="date" className={`form-control`} id="movementFrom" placeholder="Ej: Banco Río" name="date_from" value={dates.date_from}/>
          </div>
          <div className="col-12 col-lg-2">
            ...
            <button type="submit" className="btn btn-sm btn-primary align-self-end d-flex justify-content-center col-12 col-md-2"><span className="material-symbols-outlined me-1">search</span>Buscar</button>
            <button onClick={()=>handleReset()} type="reset" className="btn btn-sm btn-secondary align-self-end d-flex justify-content-center col-12 col-md-2"><span className="material-symbols-outlined me-1">ink_eraser</span>Limpiar</button>
        </form>
