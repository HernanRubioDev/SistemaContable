...
const AddMovementTableRow = ({line, removeLine})=>{
  const {account, type, ammount} = line
  return(
  <tr>
    ...
    <td><input className="form-control form-control-sm col-2 text-center" type="text" name="debit" disabled defaultValue={type === 'debit' ? ammount : ''}/></td>
    <td><input className="form-control form-control-sm col-2 text-center" type="text" name="credit" disabled defaultValue={type === 'credit' ? ammount : ''}/></td>
